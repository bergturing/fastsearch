...
var FastSearchRole = (function(){
    ...
    var _add = function(){
        var title = '添加角色';
        var url = '/admin/account/role/add';
        var width = '900';
        var height;
    ...
    var _batchDelete = function(){
        ...
        //提交请求
        layer.confirm('角色信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/account/role/batch',
                type: 'POST',
    ...
    var _edit = function(){
        var title = '编辑角色';
        var url = '/admin/account/role/edit?id=' + $(this).attr("primaryKey");
        var width = '900';
        var height;
    ...
    var _delete = function(){
        ...
        layer.confirm('角色信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/account/role/' + $(obj).attr("primaryKey"),
                type: 'DELETE',
                dataType: 'json',
                success: function (data) {
