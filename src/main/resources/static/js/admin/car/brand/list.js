var fastSerachCarBrand;

$(function(){
    fastSerachCarBrand = new FastSearchCarBrand().init();
});

var FastSearchCarBrand = (function(){
    ...
    var _batchDelete = function(){
        ...
        //提交请求
        layer.confirm('品牌信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/brand/batch',
                type: 'POST',
    ...
    var _edit = function(){
        var title = '编辑品牌';
        var url = '/admin/car/brand/edit?id=' + $(this).attr("primaryKey");
        var width = '900';
        var height;
    ...
    var _delete = function(){
        ...
        layer.confirm('品牌信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/brand/' + $(obj).attr("primaryKey"),
                type: 'DELETE',
                dataType: 'json',
                success: function (data) {
     ...
     * 内部对象
     */
    var _fastSerachCarBrand = function () {};

    /**
     * 初始化代码
     */
    _fastSerachCarBrand.prototype.init = function(){
        _init();
        _loadData();
    };

    return _fastSerachCarBrand;
})();