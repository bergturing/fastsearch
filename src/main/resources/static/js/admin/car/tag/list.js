var fastSerachCarTag;

$(function(){
    fastSerachCarTag = new FastSearchCarTag().init();
});

var FastSearchCarTag = (function(){
    ...
    var _batchDelete = function(){
        ...
        //提交请求
        layer.confirm('标签信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/tag/batch',
                type: 'POST',
    ...
    var _edit = function(){
        var title = '编辑标签';
        var url = '/admin/car/tag/edit?id=' + $(this).attr("primaryKey");
        var width = '900';
        var height;
    ...
    var _delete = function(){
        ...
        layer.confirm('标签信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/tag/' + $(obj).attr("primaryKey"),
                type: 'DELETE',
                dataType: 'json',
                success: function (data) {
     ...
     * 内部对象
     */
    var _fastSerachCarTag = function () {};

    /**
     * 初始化代码
     */
    _fastSerachCarTag.prototype.init = function(){
        _init();
        _loadData();
    };

    return _fastSerachCarTag;
})();