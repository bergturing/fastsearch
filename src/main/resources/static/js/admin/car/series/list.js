var fastSerachCarSeries;

$(function(){
    fastSerachCarSeries = new FastSearchCarSeries().init();
});

var FastSearchCarSeries = (function(){
    ...
    var _batchDelete = function(){
        ...
        //提交请求
        layer.confirm('系列信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/series/batch',
                type: 'POST',
    ...
    var _edit = function(){
        var title = '编辑系列';
        var url = '/admin/car/series/edit?id=' + $(this).attr("primaryKey");
        var width = '900';
        var height;
    ...
    var _delete = function(){
        ...
        layer.confirm('系列信息删除须谨慎，确认要删除吗？', function (index) {
            $.ajax({
                url: '/car/series/' + $(obj).attr("primaryKey"),
                type: 'DELETE',
                dataType: 'json',
                success: function (data) {
     ...
     * 内部对象
     */
    var _fastSerachCarSeries = function () {};

    /**
     * 初始化代码
     */
    _fastSerachCarSeries.prototype.init = function(){
        _init();
        _loadData();
    };

    return _fastSerachCarSeries;
})();